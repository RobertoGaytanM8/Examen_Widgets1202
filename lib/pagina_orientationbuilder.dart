...
class PaginaOrientationbuilder extends StatefulWidget {
  const PaginaOrientationbuilder({Key? key}) : super(key: key);

  @override
  State<PaginaOrientationbuilder> createState() => _MyOrientationBuilderState();
}

class _MyOrientationBuilderState extends State<PaginaOrientationbuilder> {
  @override
